...
import { getMediaItemUrl, getMediaUrl } from "@/lib/strapi";
        ...
        switch (component) {
          ...
          case "blog.quote":
            return (
              <blockquote
                key={index}
                className="border-l-4 border-[#2dd4bf] pl-5 py-2 my-6 bg-[#0d2029]/50 rounded-r-xl pr-4"
              >
          ...
          case "blog.gallery": {
            // Strapi v5: gallery_images — плоский массив медиа
            // Strapi v4: gallery_images.data[].attributes.url
            // getMediaUrl разбирает оба варианта
            const raw =
              block.gallery_images?.data || block.gallery_images || [];
