import { Linkedin, Send, Mail, Headphones, Phone, MapPin } from 'lucide-react';
    ...
    <footer className="border-t" style={{ backgroundColor: '#0d2029', borderColor: 'rgba(45, 212, 191, 0.08)' }}>
      <div className="content-container py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          {/* Company Info */}
          <div>
            <span className="text-xl font-bold tracking-tight block mb-3" style={{ color: '#e0f7fa' }}>МОТИТ</span>
            <p className="text-sm leading-relaxed mb-4" style={{ color: 'rgba(128, 222, 234, 0.6)' }}>
              Ваш надежный IT-партнер. Полный спектр IT-услуг для бизнеса любого масштаба.
            </p>
            <div className="flex gap-3">
              {[
                { icon: Linkedin, href: 'https://linkedin.com', label: 'LinkedIn' },
                { icon: Send, href: 'https://t.me/motit', label: 'Telegram' },
                { icon: Headphones, href: 'https://help.motit.by', label: 'Поддержка', ext: true },
                ...
                <a
                  ...
                  style={{ borderColor: 'rgba(45, 212, 191, 0.1)', color: 'rgba(128, 222, 234, 0.6)' }}
                  aria-label={label}
                >
                  <Icon size={16} />
                </a>
          ...
          {/* Contacts */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: '#e0f7fa' }}>Контакты</h4>
            <div className="flex flex-col gap-3">
              <a
          ...
          {/* Support */}
          <div>
            <h4 className="text-sm font-semibold uppercase tracking-wider mb-4" style={{ color: '#e0f7fa' }}>Поддержка</h4>
            <p className="text-sm leading-relaxed mb-4" style={{ color: 'rgba(128, 222, 234, 0.6)' }}>
        ...
        <div className="border-t pt-8 text-center" style={{ borderColor: 'rgba(45, 212, 191, 0.08)' }}>
          <p className="text-xs uppercase tracking-[0.05em]" style={{ color: 'rgba(77, 208, 225, 0.45)' }}>
